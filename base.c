...
void nomad_stack(int in,int cn) {
    ...
    if (it[in].ID==IID_AREA19_SALT) { name="ounce"; item="salt"; } else if (it[in].ID==IID_AREA19_WOLFSSKIN) { name="skin"; item="skin1"; } else if (it[in].ID==IID_AREA19_WOLFSSKIN2) { name="skin"; item="skin2"; } else {
