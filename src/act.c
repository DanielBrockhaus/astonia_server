...
static int sub_attack(int cn,int co,int vcn,int vco,int direct) {
    ...
    if (diff<-146)      { chance=10; per=90; } else if (diff<-128) { chance=11; per=90; } else if (diff<-112) { chance=12; per=90; } else if (diff<-96) { chance=13; per=90; } else if (diff<-80) { chance=14; per=90; } else if (diff<-72) { chance=15; per=90; } else if (diff<-64) { chance=16; per=90; } else if (diff<-56) { chance=17; per=90; } else if (diff<-48) { chance=18; per=90; } else if (diff<-40) { chance=19; per=90; } else if (diff<-36) { chance=20; per=90; } else if (diff<-32) { chance=22; per=90; } else if (diff<-28) { chance=24; per=90; } else if (diff<-24) { chance=26; per=90; } else if (diff<-20) { chance=28; per=90; } else if (diff<-18) { chance=30; per=90; } else if (diff<-16) { chance=32; per=90; } else if (diff<-14) { chance=34; per=90; } else if (diff<-12) { chance=36; per=90; } else if (diff<-10) { chance=38; per=90; } else if (diff<-8) { chance=40; per=90; } else if (diff<-6) { chance=42; per=90; } else if (diff<-4) { chance=44; per=90; } else if (diff<-2) { chance=46; per=90; } else if (diff<0) { chance=48; per=90; } else if (diff==0) { chance=50; per=90; } else if (diff<2) { chance=52; per=90; } else if (diff<4) { chance=54; per=90; } else if (diff<6) { chance=56; per=90; } else if (diff<8) { chance=58; per=90; } else if (diff<10) { chance=60; per=90; } else if (diff<12) { chance=62; per=90; } else if (diff<14) { chance=64; per=90; } else if (diff<16) { chance=66; per=85; } else if (diff<18) { chance=68; per=80; } else if (diff<20) { chance=70; per=75; } else if (diff<24) { chance=72; per=70; } else if (diff<28) { chance=74; per=65; } else if (diff<32) { chance=76; per=60; } else if (diff<36) { chance=78; per=55; } else if (diff<40) { chance=80; per=50; } else if (diff<44) { chance=81; per=45; } else if (diff<48) { chance=82; per=40; } else if (diff<52) { chance=83; per=35; } else if (diff<56) { chance=84; per=30; } else if (diff<60) { chance=85; per=25; } else if (diff<64) { chance=86; per=20; } else if (diff<68) { chance=87; per=15; } else if (diff<72) { chance=89; per=10; } else               { chance=90; per=5; }
...
void stealth_special(int cn) {
    ...
    switch (ch[cn].action) {
        ...
        case AC_BLESS_SELF:
        case AC_DROP:
        case AC_WALK:		if ((ticker&7)==7) { ch[cn].endurance-=POWERSCALE/5; ch[cn].flags|=CF_SMALLUPDATE; }
            break;
        default:
            { ch[cn].endurance=0; ch[cn].flags|=CF_SMALLUPDATE; }
            break;
    }
