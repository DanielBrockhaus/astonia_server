    ...
    if (cn) {
        ...
        if (pwr) {
            ...
            if (find_target(in,it[in].x,it[in].y,dx,dy,&shot)) {
                ...
                if (*(unsigned short *)(it[in2].drdata+1)>lpwr) { *(unsigned short *)(it[in2].drdata+1)-=lpwr; lpwr=0; } else { lpwr-=*(unsigned short *)(it[in2].drdata+1); *(unsigned short *)(it[in2].drdata+1)=0; }
                if (*(unsigned short *)(it[in3].drdata+1)>lpwr) { *(unsigned short *)(it[in3].drdata+1)-=lpwr; lpwr=0; } else { lpwr-=*(unsigned short *)(it[in3].drdata+1); *(unsigned short *)(it[in3].drdata+1)=0; }
                if (*(unsigned short *)(it[in4].drdata+1)>lpwr) { *(unsigned short *)(it[in4].drdata+1)-=lpwr; lpwr=0; } else { lpwr-=*(unsigned short *)(it[in4].drdata+1); *(unsigned short *)(it[in4].drdata+1)=0; }
            }
            if (!(it[in].sprite&1)) {
                it[in].sprite|=1;
                set_sector(it[in].x,it[in].y);
...
void fdemon_farm(int in,int cn) {
    ...
    if (str<size) { str+=step; crystal=0; nr=0; } else {
        if (size>=48) { crystal=59043; nr=5; } else if (size>=40) { crystal=59042; nr=4; } else if (size>=32) { crystal=59041; nr=3; } else if (size>=24) { crystal=59040; nr=2; } else { crystal=59020; nr=1; }
    }
