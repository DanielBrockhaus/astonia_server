...
void special_rat_reward(int cn,int co,struct rat_data *ppd) {
    ...
    if (ppd->score>=100000) { pts=100000; in=create_special_item(20,90,1,50); } else if (ppd->score>=50000) { pts=50000; in=create_special_item(20,90,1,250); } else if (ppd->score>=25000) { pts=25000; in=create_special_item(20,90,1,1000); } else if (ppd->score>=10000) { pts=10000; in=create_special_item(20,90,1,10000); } else if (ppd->score>=5000) { pts=5000; in=create_item("healing_potion3"); } else if (ppd->score>=2500) { pts=2500; in=create_item("healing_potion2"); } else if (ppd->score>=1000) { pts=1000; in=create_item("healing_potion1"); }
